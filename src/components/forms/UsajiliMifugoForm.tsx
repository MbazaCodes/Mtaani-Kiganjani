...
export const UsajiliMifugoForm: React.FC<FormProps> = ({ onSubmit, isLoading, lang = "sw", userProfile }) => {
  ...
  if (submitted) return (
    <div className="text-center py-10 space-y-4">
      ...
      <p className="text-stone-500 text-sm">{L(lang, "Usajili wa Mifugo litashughulikiwa na ofisi.", "Livestock Registration will be processed by the office.")}</p>
    ...
    <div className="space-y-5">
      ...
      {step === "details" && (
        <div className="space-y-4">
          <div className={secHdr}><p className="font-bold text-emerald-800 text-sm">USAJILI WA MIFUGO / LIVESTOCK REGISTRATION</p></div>
