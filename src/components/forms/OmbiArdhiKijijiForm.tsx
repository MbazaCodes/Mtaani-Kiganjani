...
export const OmbiArdhiKijijiForm: React.FC<FormProps> = ({ onSubmit, isLoading, lang = "sw", userProfile }) => {
  ...
  if (submitted) return (
    <div className="text-center py-10 space-y-4">
      ...
      <p className="text-stone-500 text-sm">{L(lang, "Ombi la Ardhi ya Kijiji litashughulikiwa na ofisi.", "Village Land Allocation Request will be processed by the office.")}</p>
    ...
    <div className="space-y-5">
      ...
      {step === "details" && (
        <div className="space-y-4">
          <div className={secHdr}><p className="font-bold text-emerald-800 text-sm">OMBI LA ARDHI YA KIJIJI / VILLAGE LAND ALLOCATION REQUEST</p></div>
