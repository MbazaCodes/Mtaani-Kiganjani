...
export const ChetiMwanafunziForm: React.FC<FormProps> = ({ onSubmit, isLoading, lang = "sw", userProfile }) => {
  ...
  if (submitted) return (
    <div className="text-center py-10 space-y-4">
      ...
      <p className="text-stone-500 text-sm">{L(lang, "Cheti cha Mwanafunzi litashughulikiwa na ofisi.", "Student Identity Certificate will be processed by the office.")}</p>
    ...
    <div className="space-y-5">
      ...
      {step === "details" && (
        <div className="space-y-4">
          <div className={secHdr}><p className="font-bold text-emerald-800 text-sm">CHETI CHA MWANAFUNZI / STUDENT IDENTITY CERTIFICATE</p></div>
