    ...
    <Document>
      <Page size="A4" style={s.page}>
        ...
        <View style={s.infoBox}>
          <View style={s.field}><Text style={s.fieldLabel}>{"Mmiliki / Owner"}</Text><Text style={s.fieldValue}>{String(fd.applicant_name || "")}</Text></View>
          ...
          <View style={s.feeBox}><Text style={s.feeText}>{sw ? "Ada: TSh 3,000" : "Fee: TSh 3,000"}</Text></View>
        </View>
