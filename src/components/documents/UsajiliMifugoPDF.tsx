/**
 * UsajiliMifugoPDF — Usajili wa Mifugo / Livestock Registration Certificate
 */
...
export const UsajiliMifugoPDF: React.FC<Props> = ({ application, lang = "sw", qrDataUrl }) => {
  ...
  return (
    <Document>
      <Page size="A4" style={s.page}>
        ...
        <Text style={s.docTitle}>USAJILI WA MIFUGO</Text>
        <View style={s.refBox}>
        ...
        <View style={s.infoBox}>
          <View style={s.field}>
            ...
            <Text style={s.fieldValue}>{String(fd.applicant_name || "")}</Text>
          </View>
          <View style={s.field}>
            <Text style={s.fieldLabel}>{"NIDA"}</Text>
            <Text style={s.fieldValue}>{String(fd.applicant_nida || "")}</Text>
          </View>
          <View style={s.field}>
            <Text style={s.fieldLabel}>{"Simu / Phone"}</Text>
            <Text style={s.fieldValue}>{String(fd.applicant_phone || "")}</Text>
          </View>
          <View style={s.field}>
            <Text style={s.fieldLabel}>{"Kata / Ward"}</Text>
            <Text style={s.fieldValue}>{String(fd.ward || "")}</Text>
          </View>
          <View style={s.field}>
            <Text style={s.fieldLabel}>{"Maelezo / Details"}</Text>
            <Text style={s.fieldValue}>{String(fd.details || "")}</Text>
          </View>
          <View style={s.field}>
          ...
          <View style={s.feeBox}>
            <Text style={s.feeText}>{sw ? "Ada: TSh 3,000" : "Fee: TSh 3,000"}</Text>
          </View>
        </View>
...
export default UsajiliMifugoPDF;
