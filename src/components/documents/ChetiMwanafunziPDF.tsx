/**
 * ChetiMwanafunziPDF — Cheti cha Mwanafunzi / Student Identity Certificate
 */
  ...
  return (
    <Document>
      <Page size="A4" style={s.page}>
        ...
        <Text style={s.docTitle}>CHETI CHA MWANAFUNZI</Text>
        ...
        <View style={s.infoBox}>
          ...
          <View style={s.feeBox}><Text style={s.feeText}>{sw ? "Ada: TSh 2,000" : "Fee: TSh 2,000"}</Text></View>
        </View>
