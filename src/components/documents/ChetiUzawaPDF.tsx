/**
 * ChetiUzawaPDF — Cheti cha Uzawa / Birth Certificate Application
 */
...
export const ChetiUzawaPDF: React.FC<Props> = ({ application, lang = "sw", qrDataUrl }) => {
  ...
  return (
    <Document>
      <Page size="A4" style={s.page}>
        ...
        <Text style={s.docTitle}>CHETI CHA UZAWA</Text>
        <View style={s.refBox}>
        ...
        <View style={s.infoBox}>
          <View style={s.field}>
            <Text style={s.fieldLabel}>{"Mwombaji / Applicant"}</Text>
