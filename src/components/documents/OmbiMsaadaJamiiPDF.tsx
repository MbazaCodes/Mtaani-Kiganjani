/**
 * OmbiMsaadaJamiiPDF — Ombi la Msaada wa Jamii / Social Welfare Application
 */
...
export const OmbiMsaadaJamiiPDF: React.FC<Props> = ({ application, lang = "sw", qrDataUrl }) => {
  ...
  return (
    <Document>
      <Page size="A4" style={s.page}>
        ...
        <Text style={s.docTitle}>MSAADA WA JAMII</Text>
        <View style={s.refBox}>
...
export default OmbiMsaadaJamiiPDF;
