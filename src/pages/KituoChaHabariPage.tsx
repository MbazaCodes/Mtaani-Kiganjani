...
const news = [
  {
    ...
    tagColor: "emerald",
    title: {
      sw: "E-Mtaa Inazinduliwa Rasmi Tanzania",
      en: "E-Mtaa Officially Launched in Tanzania",
    },
    body: {
      sw: "Mfumo wa Mtaani Kiganjani umezinduliwa rasmi kwa wananchi wote wa Tanzania, ukiwezesha kuomba huduma za serikali ya mtaa bila kwenda ofisini. Huduma tisa za awali zinajumuisha cheti cha mkazi, vibali vya ujenzi, mazishi, sherehe, na zaidi.",
      en: "The Mtaani Kiganjani system has been officially launched for all Tanzanian citizens, enabling ward-level government service applications without visiting offices. Nine initial services include residency certificates, construction, burial and celebration permits, and more.",
    },
  },
  {
    date: "2025-05-15",
    ...
    tagColor: "blue",
    title: {
      sw: "Malipo ya M-Pesa, Tigo Pesa na Airtel Money Sasa Yanafanya Kazi",
      en: "M-Pesa, Tigo Pesa and Airtel Money Payments Now Live",
    },
    body: {
      sw: "Wananchi wanaweza sasa kulipa ada za huduma kupitia M-Pesa, Tigo Pesa, au Airtel Money moja kwa moja ndani ya mfumo wa E-Mtaa. Malipo ya benki (NMB, CRDB, NBC) na kadi za Visa/Mastercard pia yanakubaliwa.",
      en: "Citizens can now pay service fees via M-Pesa, Tigo Pesa, or Airtel Money directly within E-Mtaa. Bank transfers (NMB, CRDB, NBC) and Visa/Mastercard payments are also accepted.",
    },
  },
  {
    date: "2025-04-20",
    ...
    tagColor: "purple",
    title: {
      sw: "E-Mtaa Inaunganishwa na Mfumo wa NIDA",
      en: "E-Mtaa Integrated with NIDA System",
    },
    body: {
      sw: "Ushirikiano na Mamlaka ya Vitambulisho vya Taifa (NIDA) unawezesha uthibitishaji wa haraka wa utambulisho wa wananchi ndani ya mfumo, kuongeza usalama na kuzuia udanganyifu.",
      en: "Partnership with the National Identification Authority (NIDA) enables fast citizen identity verification within the system, enhancing security and preventing fraud.",
    },
  },
  {
    date: "2025-03-10",
    ...
    tagColor: "orange",
    title: {
      sw: "Majaribio Yanakamilika Mafanikio Dar es Salaam",
      en: "Pilot Completes Successfully in Dar es Salaam",
    },
    body: {
      sw: "Kipindi cha majaribio katika wilaya tatu za Dar es Salaam kilikamilika kwa mafanikio, wakihusu wananchi 2,400 na maombi 1,800 yaliyoshughulikiwa kwa muda wa wiki nane.",
      en: "The pilot period across three Dar es Salaam districts concluded successfully, involving 2,400 citizens and 1,800 applications processed over eight weeks.",
    },
  },
];
    ...
    <div className="max-w-4xl mx-auto py-8 px-4 space-y-8">
      ...
      <div className="space-y-4">
        ...
        {news.map((item, i) => (
          <div
            key={i}
            className="bg-white border border-stone-100 rounded-2xl p-5 hover:border-emerald-200 hover:shadow-sm transition-all"
          >
            <div className="flex items-center gap-2 mb-3 flex-wrap">
              <span
                className={`text-[10px] font-black px-2 py-0.5 rounded-full uppercase tracking-wide ${tagColorMap[item.tagColor]}`}
              >
                {sw ? item.tag.sw : item.tag.en}
              </span>
              <span className="text-stone-400 text-xs flex items-center gap-1">
                <Calendar size={11} />
                {new Date(item.date).toLocaleDateString(sw ? "sw-TZ" : "en-GB", {
                  day: "numeric",
                  month: "long",
                  year: "numeric",
                })}
